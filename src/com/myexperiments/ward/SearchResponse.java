...
public class SearchResponse {
	...
	public static class Response {
		...
		@Override
		public String toString() {
			return "Response{" + "numFound=" + numFound + ", start=" + start + ", maxScore=" + maxScore + ", docs="
					+ docs + '}';
		}
	}
	...
	public static class FacetCountsCollection {
		...
		public List<FacetCountsCollection.FacetValue> getFacetField(String field) {
			...
			// this was written assuming that facetFields contains a map, but in recent
			// versions of Solr at least it's an array.
