...
public class GunzipOutputStream extends InflaterOutputStream {
	...
	private enum HeaderState {
		ID1, ID2, CM, FLG, MTIME_0, MTIME_1, MTIME_2, MTIME_3, XFL, OS, XLEN_0, XLEN_1, FEXTRA, FNAME, FCOMMENT,
		CRC16_0, CRC16_1, DONE
	}
	...
	private class GZIPHeader {
		...
		private void adjustStateAccordingToFlags(HeaderState... previousStates) {
			EnumSet<HeaderState> previous = previousStates.length == 0 ? EnumSet.noneOf(HeaderState.class)
