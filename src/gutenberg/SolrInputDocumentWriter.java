 ...
 * <p>
 * Implementations of this class may write directly to Solr, or to any other
 * underlying store than can handle SolrInputDocuments.
 */
public interface SolrInputDocumentWriter {
	 ...
	 *
	 * @param shard
	 *            shard id (ignored when using solr cloud)
	 * @param inputDocumentMap
	 *            map of document ids to {@code SolrInputDocument}s
	 */
	...
	/**
	 * Has the same behavior as {@link SolrClient#deleteByQuery(String)} (optional
	 * operation).
	 *
	 * @param deleteQuery
